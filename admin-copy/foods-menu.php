...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Orchid Bliss</span>
      </a>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Foods</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Food Management</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
    <div class="container-fluid">
        <div class="row mt-4">
        <h3 class="font-weight-bolder ">PASTRY SHOP</h3>
              ...
              <div class="row">
                <div>
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder">Foods of Pastry Shop</h5>
                    ...
                    <button type="button" class="btn btn-secondary btn-lg">Add food Items</button>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div>
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold"></p>
                    <h5 class="font-weight-bolder">Food categories of Pastry Shop</h5>
                    ...
                    <button type="button" class="btn btn-secondary btn-lg">Add food category</button>
                    </a>
                  </div>
                </div>
              </div>
      ...
      <div class="row mt-4">
       <h3 class="font-weight-bolder ">THE LOUNGE</h3>
        <div class="col-lg-6 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
