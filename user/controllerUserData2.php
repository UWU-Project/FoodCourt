...
require '../contactUs/vendor/phpmailer/phpmailer/src/Exception.php';
require '../contactUs/vendor/phpmailer/phpmailer/src/PHPMailer.php';
...
if(isset($_POST['signup' ])){
    ...
    if(count($errors) === 0){
        ...
        $status = "notverified";
        $insert_data = "INSERT INTO users (firstname, lastname, email, password, code, status)
