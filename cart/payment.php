...
<div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px" class="card-body">
    ...
    <table width="910" height="auto" style="text-align:center;" class="table table-borderless table-hover" w-auto>
        ...
        foreach ($result as $row) {
            ...
            echo '<td colspan="9" class="table-active"><button name="'. $row['total'] .'" value="'. $row['cart_id'] .'" onclick="Payment(this)"><i class="btn btn-warning" >Place Order</i></button></td>';
        ...
        foreach ($result_lounge as $row) {
            ...
            echo '<td colspan="9" class="table-active"><a onclick="Payment()"><i class="btn btn-warning" >Place Order</i></a></td>';
        ...
        <script>
            function Payment(btn){
                document.getElementById("order_id").value = btn.value;
...
<form method="post" action="https://sandbox.payhere.lk/pay/checkout">
    ...
    <input type="text"id="order_id" name="order_id" value="ItemNo12345">
