...
if (isset($_POST['Delete'])){
    ...
    // delete the entry
    $result = mysqli_query($conn,"DELETE FROM food_categories_lounge WHERE category_id='$category_id'")
...
if (isset($_GET['id']))
{
    ...
    // delete the entry
    $result = mysqli_query($conn,"DELETE FROM food_categories_lounge WHERE category_id='$id'")
    or die("There was a problem while deleting the category ... \n" . mysqli_error());
